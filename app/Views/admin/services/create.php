...
<div style="max-width: 800px;">
    <form action="/admin/services/create" method="POST" class="contact-form">
        ...
        <div class="form-group">
            ...
            <input type="text" id="slug" name="slug" class="form-control" required placeholder="installation">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="icon" name="icon" class="form-control" placeholder="tools">
        </div>
